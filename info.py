...
# Bot information
API_ID = environ.get('API_ID', '19481274')
if len(API_ID) == 0:
    logger.error('API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'edbb4d162c4871c25ccd6f7179dad8cf')
if len(API_HASH) == 0:
    logger.error('API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '8253314933:AAE_pkVudo2CJKEI_3fX70h56fNHU5HcZK4')
if len(BOT_TOKEN) == 0:
...
PICS = (environ.get('PICS', 'https://envs.sh/bZs.jpg https://envs.sh/bZN.jpg https://envs.sh/bZH.jpg https://envs.sh/bZg.jpg https://envs.sh/bZf.jpg https://envs.sh/bZa.jpg https://envs.sh/bZO.jpg https://envs.sh/bZm.jpg https://envs.sh/bZV.jpg https://envs.sh/bZ6.jpg https://envs.sh/bZy.jpg https://envs.sh/bZX.jpg https://i.postimg.cc/8C15CQ5y/1.png https://i.postimg.cc/gcNtrv0m/2.png https://i.postimg.cc/cHD71BBz/3.png https://i.postimg.cc/F1XYhY8q/4.png https://i.postimg.cc/1tNwGVxC/5.png https://i.postimg.cc/dtW30QpL/6.png https://i.postimg.cc/139dvs3c/7.png https://i.postimg.cc/QtXVtB8K/8.png https://i.postimg.cc/y8j8G1XV/9.png https://i.postimg.cc/zDF6KyJX/10.png https://i.postimg.cc/fyycVqzd/11.png https://i.postimg.cc/26ZBtBZr/13.png https://i.postimg.cc/PJn8nrWZ/14.png https://i.postimg.cc/cC7txyhz/15.png https://i.postimg.cc/kX9tjGXP/16.png https://i.postimg.cc/zXjH4NVb/17.png https://i.postimg.cc/sggGrLhn/18.png https://i.postimg.cc/y8pgYTh7/19.png')).split()

# Bot Admins
ADMINS = environ.get('ADMINS', '677605082 6585564185')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-1002899768746") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '').split()]
if len(INDEX_CHANNELS) == 0:
    logger.info('INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002933718411')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1003090077879')
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "mongodb+srv://jicin98753_db_user:Neymarjr@cluster0.k1sxmam.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(DATA_DATABASE_URL) == 0:
    logger.error('DATA_DATABASE_URL is missing, exiting now')
    exit()
FILES_DATABASE_URL = environ.get('FILES_DATABASE_URL', "mongodb+srv://jrnedved1:UaYg7rRcCOR0HtOb@cluster0.lx0jvus.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(FILES_DATABASE_URL) == 0:
    logger.error('FILES_DATABASE_URL is missing, exiting now')
    exit()
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', "mongodb+srv://filokit756_db_user:hpB2FG9QXRmZb7Ke@cluster0.eopd3fy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/MoviepubGroup')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/moviemediachannel')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/MoviepubGroup')
...
DELETE_TIME = int(environ.get('DELETE_TIME', 900)) # Add time in seconds
...
PM_FILE_DELETE_TIME = int(environ.get('PM_FILE_DELETE_TIME', '900'))
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1003083281607")
if len(BIN_CHANNEL) == 0:
    logger.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/AutofilterCF3bot")
if len(URL) == 0:
